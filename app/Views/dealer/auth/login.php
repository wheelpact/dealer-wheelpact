					...
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form method="post" id="loginForm" action="<?php echo base_url() ?>dealer/login/auth">
							<div class="input-group custom">
								<input name="username" type="text" id="username" class="form-control form-control-lg" placeholder="Username" required>
								<div class="input-group-append custom">
									<span class="input-group-text"><i class="icon-copy dw dw-user1"></i></span>
								</div>
							</div>
							<div class="input-group custom">
								<input name="password" type="password" minlength="8" maxlength="12" id="password" class="form-control form-control-lg" placeholder="**********" required>
								<div class="input-group-append custom">
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="font-16 weight-600 pt-10 pb-10 text-center d-none" data-color="#707373">OR</div>
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block d-none" href="<?php echo base_url('dealer/register'); ?>">Register To Create Account</a>
									</div>
								</div>
							</div>
						</form>
