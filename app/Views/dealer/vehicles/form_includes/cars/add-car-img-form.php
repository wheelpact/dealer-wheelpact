            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="file" name="exterior_main_right_img" id="exterior_main_right_img" class="form-control-file form-control height-auto onlyImageInput" accept="image/png, image/jpeg, image/jpg" required>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Back Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Left Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Roof Image<span class="required d-none"></label>
                        <input type="file" name="exterior_main_roof_img" id="exterior_main_roof_img" class="form-control-file form-control height-auto onlyImageInput" accept="image/png, image/jpeg, image/jpg" required>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Bonet Open Image<span class="required d-none"></label>
                        <input type="file" name="exterior_main_bonetopen_img" id="exterior_main_bonetopen_img" class="form-control-file form-control height-auto onlyImageInput" accept="image/png, image/jpeg, image/jpg" required>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Engine Image<span class="required d-none"></label>
    ...
    <div class="card-header" id="headingTwo">
        <h2 class="mb-0">
            <button class="btn btn-link collapsed" id="exterior_diagnoal_toggle_btn" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                Diagonal Images<span class="required d-none">
            </button>
        </h2>
    </div>
    ...
    <div id="collapseTwo" class="collapse exterior_diagnoal" aria-labelledby="headingTwo" data-parent="#vehicleExteriorImagesWrapper">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Right Front Diagonal Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Right Back Diagonal Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Left Back Diagonal Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Left Front Diagonal Image<span class="required d-none"></label>
    ...
    <div class="card-header" id="headingThree">
        <h2 class="mb-0">
            <button class="btn btn-link collapsed" id="exterior_wheel_toggle_btn" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                Wheel Images<span class="required d-none">
            </button>
        </h2>
    </div>
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#vehicleExteriorImagesWrapper">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Right Front Wheel Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Right Back Wheel Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Left Back Wheel Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Left Front Wheel Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Spare Wheel Image<span class="required d-none"></label>
    ...
    <div class="card-header" id="headingFour">
        <h2 class="mb-0">
            <button class="btn btn-link collapsed" id="exterior_tyrethread_toggle_btn" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                Tyre Tread Images<span class="required d-none">
            </button>
        </h2>
    </div>
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#vehicleExteriorImagesWrapper">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Right Front Tyre Tread Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Right Back Tyre Tread Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Left Back Tyre Tread Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Left Front Tyre Tread Image<span class="required d-none"></label>
    ...
    <div class="card-header" id="headingFive">
        <h2 class="mb-0">
            <button class="btn btn-link collapsed" id="exterior_underbody_toggle_btn" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                Underbody Images<span class="required d-none">
            </button>
        </h2>
    </div>
    ...
    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#vehicleExteriorImagesWrapper">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Front Underbody Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Rear Underbody Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Right Side Underbody Image<span class="required d-none"></label>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>Left Side Underbody Image<span class="required d-none"></label>
