                ...
                <div class="accordion" id="vehicleExteriorImagesWrapper">
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            <h5 class="text-blue"><button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Main Images<span class="required">*</span></button></h5>
                        </div>
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                                                <div class="da-card">
                                                    <div class="da-card-photo">
                                                        <img src="<?php echo isset($label) && !empty($label) ? WHEELPACT_VEHICLE_UPLOAD_IMG_PATH . 'vehicle_' . $key . '/' . $label : WHEELPACT_VEHICLE_UPLOAD_IMG_PATH . 'default-img.png'; ?>" class="img img-responsive" alt="<?php echo $label; ?>">
                                                        <div class="da-overlay">
                                                            <div class="da-social">
                                                                <ul class="clearfix">
                                                                    <li>
                                                                        <a href="<?php echo isset($label) && !empty($label) ? WHEELPACT_VEHICLE_UPLOAD_IMG_PATH . 'vehicle_' . $key . '/' . $label : ''; ?>" data-fancybox="images" data-caption="<?php echo ucwords(implode(' ', array_slice(explode('_', $key), 2, 2))); ?>"><i class="fa fa-picture-o"></i></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="da-card-content">
                                                        <p class="mb-0"><?php echo ucwords(implode(' ', array_slice(explode('_', $key), 2, 2))); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                    <?php
